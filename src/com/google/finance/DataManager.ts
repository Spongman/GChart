...
import { Map } from '../../../Global';
	...
	export class DataManager {
		...
		constructor(readonly mainManager: MainManager, private startTime = NaN, private endTime = NaN) {
		}
		...
		cloneDataUnitForTargetExchange(dataUnit1: DataUnit, dataUnit2: DataUnit, param3: number): DataUnit {
			...
			const time = Date.UTC(dataUnit1.exchangeDateInUTC.getUTCFullYear(), dataUnit1.exchangeDateInUTC.getUTCMonth(), dataUnit1.exchangeDateInUTC.getUTCDate(), dataUnit2.dayMinute / 60, dataUnit2.dayMinute % 60);
